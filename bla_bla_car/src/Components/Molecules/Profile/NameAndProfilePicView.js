...
export default function NameAndProfilePicView({setShowEditPersonalDetails}) {
    ...
    return (
        <div className='profile'>
            <div className='profileMain'>
                ...
                <PathTo linkText='Edit Personal Details' picNeeded={false} setShowEditPersonalDetails={setShowEditPersonalDetails} />
            </div>
            <div className='profileMain'>
            ...
            <div className='profileMain'>
                ...
                <PathTo linkText='Add a mini bio' />
            </div>
            <div className='profileMain'>
                <h1 className='headingData'>Vehicles</h1>
                <Linkto linkText='Add vehicle' />
            </div>
